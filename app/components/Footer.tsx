    ...
    <footer className="bg-gray-50 border-t border-gray-100">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl">QuickPrompt</span>
            </div>
            <p className="text-gray-600 mb-4 max-w-md">
              The ultimate prompt management tool for AI power users. Save, organize, and reuse your best prompts across all AI platforms.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="#" className="text-gray-600 hover:text-primary transition-colors">Prompt Templates</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} QuickPrompt. All rights reserved.</p>
